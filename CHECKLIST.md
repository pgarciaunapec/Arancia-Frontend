...
- [x] Hook useToast() con m�todos success/error/info/warning
- [x] ToastContainer component animado motion/react
- [x] Auto-dismiss 5s, bottom-right z-50
- [x] Integraci�n lista para todas las secciones
- [x] Build exitoso
- [x] Commit + merge --no-ff
...
- [x] Validación MIME types en cliente
...
- [x] Métricas cards: entradas, salidas, balance
- [x] Add movement form con tipo/categoría/amount
...
- [x] Ramas locales eliminadas post-merge
- [x] Frontend listo para integraci�n con Backend
