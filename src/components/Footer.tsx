                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                        ...
                        <Link
                            ...
                            style={{ backgroundColor: COLORS.secondary, color: COLORS.primary, border: `2px solid ${COLORS.primaryDark}` }}
                        >
                            Reservar Ahora
                            <ArrowRight size={20} />
                        </Link>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            {[
                                ...
                                <li key={link.path}>
                                    <Link to={link.path} className="text-sm transition-colors flex items-center gap-2 group hover:text-[#f5b400]" style={{ color: COLORS.white }}>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            ...
                            <li className="flex items-center gap-3 text-sm" style={{ color: COLORS.white }}>
                                ...
                                <a href="tel:+18095550123" className="hover:text-[#f5b400] transition-colors">(809) 555-0123</a>
                            </li>
                            <li className="flex items-center gap-3 text-sm" style={{ color: COLORS.white }}>
                                <Mail size={16} className="flex-shrink-0" style={{ color: COLORS.primary }} />
                                <a href="mailto:info@bobtoronja.com" className="hover:text-[#f5b400] transition-colors">info@bobtoronja.com</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                        ...
                        <div className="flex items-center gap-3">
                            <a
                                ...
                                style={{ backgroundColor: COLORS.secondaryLight, color: COLORS.white, border: `2px solid ${COLORS.primary}` }}
                            >
                                <Instagram size={18} />
                            </a>
                            <a
